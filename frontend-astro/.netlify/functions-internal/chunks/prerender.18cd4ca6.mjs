import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, f as addAttribute, b as renderComponent } from './astro.314a455b.mjs';
import { $ as $$Base } from './pages/404.astro.c37ffab6.mjs';
import { s as server_url } from './pages/_slug_.astro.8efd2505.mjs';
import 'cookie';
import 'kleur/colors';
  ...
  <nav class="navbar navbar-inverse" role="navigation">
    ...
    <div id="navbar" class="navbar-collapse collapse">
      <ul class="nav navbar-nav main_nav">
        ...
        ${categories.items.map((item, index) => renderTemplate`<li>
        ...
        <ul class="business_catgnav wow fadeInDown">
          <li>
            <figure class="bsbig_fig">
              ...
              <figcaption>
                <a${addAttribute(postsThoiSu.items[0].meta.slug, "href")}>${postsThoiSu.items[0].title}</a>
              </figcaption>
              <p>
                ${postsThoiSu.items[0].description}
              </p>
            </figure>
          </li>
        </ul>
          ...
          <ul class="business_catgnav wow fadeInDown">
            <li>
              <figure class="bsbig_fig">
                ...
                <figcaption>
                  <a${addAttribute(postsGiaoDuc.items[0].meta.slug, "href")}>${postsGiaoDuc.items[0].title}</a>
                </figcaption>
                <p>
                  ${postsGiaoDuc.items[0].description}
                </p>
              </figure>
            </li>
          </ul>
          ...
          <ul class="business_catgnav">   
            <li>
              <figure class="bsbig_fig wow fadeInDown">
                ...
                <figcaption>
                  <a${addAttribute(postsKhoaHoc.items[0].meta.slug, "href")}>${postsKhoaHoc.items[0].title}</a>
                </figcaption>
                <p>
                  ${postsKhoaHoc.items[0].description}
                </p>
              </figure>
            </li>
          </ul>
          ...
          <ul class="business_catgnav">   
            <li>
              <figure class="bsbig_fig wow fadeInDown">
                ...
                <figcaption>
                  <a${addAttribute(postsTheThao.items[0].meta.slug, "href")}>${postsTheThao.items[0].title}</a>
                </figcaption>
                <p>
                  ${postsTheThao.items[0].description}
                </p>
              </figure>
            </li>
          </ul>
